    ...
    <Pressable onPress={onPress} style={({ pressed }) => [styles.card, pressed && onPress ? styles.pressed : null]}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={[styles.severity, { color: accentColor }]}>{critical ? "CRÍTICA" : "PENDIENTE"}</Text>
        </View>
...
const styles = StyleSheet.create({
  card: { flexDirection: "row", alignItems: "center", gap: spacing.md, padding: spacing.lg, borderWidth: 1, borderColor: colors.border, borderRadius: 18, backgroundColor: colors.surface },
